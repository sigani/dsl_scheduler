...
// This class defines a complete listener for a parse tree produced by TaskProjectParser.
export default class TaskProjectParserListener extends antlr4.tree.ParseTreeListener {

	// Enter a parse tree produced by TaskProjectParser#program.
	enterProgram(ctx) {
	}

	// Exit a parse tree produced by TaskProjectParser#program.
	exitProgram(ctx) {
	}
